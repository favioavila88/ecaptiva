import '../../Styles/pages/home/HomeRow_7';
        ...
        <div className="row-7">
            ...
            <div className='row-7-container-column'>
                <div className='row-7 column'>
                    ...
                    <figure><img src={img1} className='img-1-item' /></figure>
                </div>
                <div className='row-7 column'>
                    <div className='row-7-content-text'>
                    ...
                    <figure><img src={img2} className='img-2-item' /></figure>
                </div>
                <div className='row-7 column'>
                    <div className='row-7-content-text'>
                    ...
                    <figure><img src={img3} className='img-3-item' /></figure>
                </div>
                <div className='row-7 column'>
                    <div className='row-7-content-text'>
                    ...
                    <figure><img src={img4} className='img-4-item' /></figure>
                </div>
            </div>
        </div>
    )
